...
const sqliteRepo_1 = require("../src/repo/sqliteRepo");
describe('SqliteRepo', () => {
    const payload = {
    ...
    it('upserts and retrieves records', () => {
        const rec = sqliteRepo_1.sqliteRepo.upsert({
            credentialId: 'abc123',
            payload,
        ...
        const read = sqliteRepo_1.sqliteRepo.get('abc123');
    ...
    it('returns undefined for missing id', () => {
        const read = sqliteRepo_1.sqliteRepo.get('does-not-exist');
